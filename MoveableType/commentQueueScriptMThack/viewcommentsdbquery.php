...
$query = sprintf("SELECT comment_id, comment_blog_id, comment_entry_id, comment_ip, comment_author, comment_email, comment_url, comment_created_on, comment_modified_on, comment_temp_entry_id, blog_archive_url, blog_id, entry_title, entry_id, blog_name FROM mt_comment, mt_blog, mt_entry  WHERE comment_entry_id = '%s' and blog_id = comment_blog_id and entry_id = comment_temp_entry_id ORDER BY '%s'", '0', $orderby);
